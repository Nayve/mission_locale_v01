	...
	*/	
	...
	function gdlr_conference_create_session() {
		register_post_type( 'session',
			array(
				'labels' => array(
					'name'               => __('Activités', 'gdlr-conference'),
					'singular_name'      => __('Activités', 'gdlr-conference'),
					'add_new'            => __('Créer', 'gdlr-conference'),
					'add_new_item'       => __('Créer une activité', 'gdlr-conference'),
					'edit_item'          => __('Editer l\'activité', 'gdlr-conference'),
					'new_item'           => __('Nouvelle actitvité', 'gdlr-conference'),
					'all_items'          => __('Toutes les activités', 'gdlr-conference'),
					'view_item'          => __('Voir l\'activité', 'gdlr-conference'),
					'search_items'       => __('Chercher une activité', 'gdlr-conference'),
					'not_found'          => __('Aucune activité trouvée', 'gdlr-conference'),
					'not_found_in_trash' => __('Aucune activité trouvée dans la corbeille', 'gdlr-conference'),
					'parent_item_colon'  => '',
					'menu_name'          => __('Activités', 'gdlr-conference')
				),
				'public'             => true,
		...
		register_taxonomy(
			'session_category', array("session"), array(
				...
				'label' => __('Catégories d\'activité', 'gdlr-conference'), 
				'singular_label' => __('Catégorie d\'activité', 'gdlr-conference'), 
			...
			new gdlr_page_options( 
				...
				array(
					'page-option' => array(
						...
						'options' => array(
							// 'page-caption' => array(
							// 	'title' => __('Titre de l\'activité' , 'gdlr-conference'),
							// 	'type' => 'textarea'
							// ),
							// 'session-type' => array(
							// 	'title' => __('Type de session' , 'gdlr-conference'),
							// 	'type' => 'combobox',
							// 	'options' => array(
							...
							// ),
							'session-date' => array(
								'title' => __('Début de l\'activité' , 'gdlr-conference'),
								'type' => 'date-picker'
							),
							'session-end-date' => array(
								'title' => __('Fin de l\'activité' , 'gdlr-conference'),
								'type' => 'date-picker'
							),
							// 'session-time' => array(
							...
							// ),
							'session-info' => array(
								'title' => __('Séance d\'information' , 'gdlr-conference'),
								'type' => 'text',
